...
%% Exhaustive pairs of pc
figure()
gplotmatrix(score(:,1:5),[],ripples.eventID,[],[],[],[],[],{'PC1','PC2','PC3','PC4','PC5'})
legend('sharp wave ripple','ripple','false positive')
...
%save("D:\INI\SemesterArbeitBaran\RippleAnalysis\RippleDetection\220504_DatasetConstruction\rTBY33S7_DS0511_auto_v2_features.mat","featureTable");
